# AUTOGENERATED! DO NOT EDIT! File to edit: nbs/constants/aa.ipynb (unless otherwise specified).

__all__ = ['reset_AA_mass', 'ret_set_AA_df', 'AA_CHEM', 'AA_ASCII_MASS', 'AA_DF', 'get_sequence_mass',
           'get_same_len_sequences_mass', 'get_sequence_array_mass']
...
def get_sequence_array_mass(
    ...
    '''
    We recommend to use `get_same_len_sequences_mass` as all sequence arrays will processed within numpy.
    Args:
