...
__all__ = ['keep_only_important_modloss', 'update_all_by_MOD_DF', 'add_modifications_for_lower_case_AA', 'MOD_DF',
           'MOD_INFO_DICT', 'MOD_CHEM', 'MOD_MASS', 'MOD_LOSS_MASS', 'MOD_formula', 'MOD_LOSS_IMPORTANCE',
           'load_mod_df', 'calc_modification_mass', 'calc_mod_masses_for_same_len_seqs', 'calc_modification_mass_sum',
           'calc_modloss_mass_with_importance', 'calc_modloss_mass']
...
# modloss=0 if modloss_importance=0
keep_only_important_modloss:bool = True
...
# Cell
def load_mod_df(tsv:str=os.path.join(_base_dir, 'modification.tsv')):
    global MOD_DF
