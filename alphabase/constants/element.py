...
common_dict = load_yaml(
    os.path.join(_base_dir, 'common.yaml')
)

MASS_PROTON = common_dict['MASS_PROTON']
MASS_ISOTOPE = common_dict['MASS_ISOTOPE']

# Cell

MAX_ISOTOPE_LEN = common_dict['MAX_ISOTOPE_LEN']
