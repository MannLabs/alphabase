...
__all__ = ['refine_precursor_df', 'is_precursor_refined', 'update_precursor_mz', 'reset_precursor_df',
           'is_precursor_sorted', 'calc_precursor_mz', 'get_mod_seq_hash', 'get_mod_seq_charge_hash', 'hash_mod_seq',
           'hash_mod_seq_charge', 'hash_precursor_df', 'detect_duplicated_items']
...
def get_mod_seq_hash(sequence, mods, mod_sites):
    return np.sum([
        hash64(sequence)[0],
        hash64(mods)[0],
        hash64(mod_sites)[0],
