...
__all__ = ['refine_precursor_df', 'is_precursor_refined', 'update_precursor_mz', 'reset_precursor_df',
           'is_precursor_sorted', 'calc_precursor_mz', 'get_mod_seq_formula', 'get_mod_seq_isotope_distribution',
           'calc_precursor_isotope', 'get_mod_seq_hash', 'get_mod_seq_charge_hash', 'hash_mod_seq_df',
...
def get_mod_seq_isotope_distribution(seq_mods:tuple):
    formula = get_mod_seq_formula(*seq_mods)
    dist, mono = formula_dist(list(formula.items()))
