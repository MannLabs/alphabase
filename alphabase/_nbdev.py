...
index = {"reset_AA_mass": "aa.ipynb",
         ...
         "str_to_int": "library_base.ipynb",
         "generate_modified_sequence": "library_base.ipynb",
         "merge_precursor_fragment_df": "library_base.ipynb",
         "SpecLibBase": "library_base.ipynb",
         "alpha_to_other_mod_dict": "library_base.ipynb",
