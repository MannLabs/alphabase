# AUTOGENERATED! DO NOT EDIT! File to edit: ../../nbdev_nbs/scoring/fdr.ipynb.

# %% auto 0
__all__ = ['calc_fdr_for_df', 'calc_fdr_from_ref_for_df', 'fdr_to_q_values', 'calculate_fdr', 'fdr_from_ref',
           'calculate_fdr_from_ref']

# %% ../../nbdev_nbs/scoring/fdr.ipynb 3
import numba
import numpy as np
import pandas as pd

# %% ../../nbdev_nbs/scoring/fdr.ipynb 4
@numba.njit
def fdr_to_q_values(
