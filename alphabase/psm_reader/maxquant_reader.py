# AUTOGENERATED! DO NOT EDIT! File to edit: ../../nbdev_nbs/psm_reader/maxquant_reader.ipynb.

# %% auto 0
__all__ = ['parse_mod_seq', 'MaxQuantReader']

# %% ../../nbdev_nbs/psm_reader/maxquant_reader.ipynb 2
import pandas as pd
import numpy as np
import numba
import copy
...
# %% ../../nbdev_nbs/psm_reader/maxquant_reader.ipynb 3
@numba.njit
def parse_mod_seq(
    modseq:str,
    mod_sep:str='()',
