...
PACKAGE_NAME=alphabase
# BUILD_NAME is taken from environment variables, e.g. alphabase-1.3.0-macos-darwin-arm64 or alphabase-1.3.0-macos-darwin-x64
...
mv dist_pyinstaller/alphabase_gui ${CONTENTS_FOLDER}/MacOS
cp release/macos/Info.plist ${CONTENTS_FOLDER}
cp release/macos/alphabase_terminal ${CONTENTS_FOLDER}/MacOS
