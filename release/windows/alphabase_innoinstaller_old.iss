...
OutputDir=..\..\
; example for BUILD_NAME: alphabase-1.2.1-windows-amd64
...
[Files]
Source: "..\..\dist_pyinstaller\alphabase_gui\{#MyAppExeName}"; DestDir: "{app}"; Flags: ignoreversion
Source: "..\..\dist_pyinstaller\alphabase_gui\*"; DestDir: "{app}"; Flags: ignoreversion recursesubdirs createallsubdirs
