...
pip install "../../dist/alphabase-0.0.5-py3-none-any.whl[stable]"
...
pkgbuild --root dist/alphabase --identifier de.mpg.biochem.alphabase.app --version 0.0.5 --install-location /Applications/AlphaBase.app --scripts scripts AlphaBase.pkg
