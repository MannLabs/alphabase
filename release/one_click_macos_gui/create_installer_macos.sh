...
pip install "../../dist/alphabase-1.1.1-py3-none-any.whl[stable]"
...
pkgbuild --root dist/alphabase --identifier de.mpg.biochem.alphabase.app --version 1.1.1 --install-location /Applications/AlphaBase.app --scripts scripts AlphaBase.pkg
